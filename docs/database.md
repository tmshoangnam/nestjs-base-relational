...
## About databases
 ...
 supports two types of databases: PostgreSQL with TypeORM. You can choose one of them or use both in your project. The choice of database depends on the requirements of your project.
